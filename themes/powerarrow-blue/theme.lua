...
local my_table = awful.util.table or gears.table -- 4.{0,1} compatibility  "#FF79C6"
...
theme.weather = lain.widget.weather({
    city_id = 1275665, -- placeholder (Belgium)
    notification_preset = { font = "Product Sans Font 11", fg = theme.fg_normal },
